...
export default function AnnounceDetail() {
	return (
		<>
			<div className='bg-brand-1 w-full min-h-[436px] grid place-items-center px-3'>
			...
			<div className='bg-grey-8 w-full px-3'>
				<section className='bg-grey-10 rounded w-full py-9 px-7 mb-9 relative bottom-4'>
				...
				<section className='bg-grey-10 rounded w-full py-9 px-7 mb-4'>
				...
				<section className='bg-grey-10 rounded w-full p-9'>
